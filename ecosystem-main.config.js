...
module.exports = {
    apps: [
        {
            name: 'thevalua-main', // Name of your application
            ...
            cwd: '/home/thevalb9c4y6/public_html/main', // Path to your project
            ...
            env: {
                ...
                ORIGIN: process.env.ORIGIN || 'http://localhost:3001', // Use environment variable or default
                PORT: process.env.PORT || 3001, // Use environment variable or default
