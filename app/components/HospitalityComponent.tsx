...
export default function HospitalityComponent({
  ...
  user,
  userId,
  valuationTypeFilter = ValuationType.Hospitality, // <-- Default to Residential
      ...
      <table className="min-w-full items-stretch bg-white overflow-hidden shadow-md border border-stone-200 mt-3" style={{ width: '100%' }}>
        <thead>
          <tr>
            ...
            {/* <CustomTableHeading className="py-2 px-4 text-left">Net Annual Income</CustomTableHeading> */}
            {/* <CustomTableHeading className="py-2 px-4 text-left">Annual Expenditure</CustomTableHeading> */}
            {/* <CustomTableHeading className="py-2 px-4 text-left">Operating Costs / Month (P/m<sup>2</sup>)</CustomTableHeading> */}
            {/* <CustomTableHeading className="py-2 px-4 text-left">Annual Expenditure as %</CustomTableHeading> */}
            <CustomTableHeading className="py-2 px-4 text-left">Cap Rate (%)</CustomTableHeading>
            {/* <CustomTableHeading className="py-2 px-4 text-left">Vacancy Rate (%)</CustomTableHeading> */}
            ...
            {/* <CustomTableHeading className="py-2 px-4 text-left">Rate/m<sup>2</sup> based on MV (GLA)</CustomTableHeading> */}
