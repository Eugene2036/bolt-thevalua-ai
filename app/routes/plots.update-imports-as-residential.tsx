...
export async function action({ request, params }: ActionArgs) {
  ...
  for (let row of rows) {
    ...
    console.log(neighbourhood, location, plotSize, inspectionDate, neighbourhood, structure);
    ...
    await prisma.plot.update({
      where: { id: plot.id },
      data: { valuationType: ValuationType.Residential },
    });
...
export default function UpdateImportedPlots() {
            ...
            <ActionContextProvider {...fetcher.data} isSubmitting={isProcessing}>
              ...
              <PrimaryButton type="submit" className="bg-teal-600 hover:bg-teal-800 focus:bg-teal-800">
                <div className="flex flex-row items-center gap-4">
                  ...
                  <span>Import The {rows.length} Plot(s) Below</span>
                </div>
              </PrimaryButton>
