...
export async function loader({ request }: LoaderArgs) {
  ...
  const calculatorKind = CalculatorKind.SHHA_House_Types;
  ...
  const inputs: [string, number, number, number][] = [
    ...
    [PropertyOption.Veranda.Yes, ...([2030, 2610, 1800] as [number, number, number])],
      ...
      data: {
        ...
        items: {
          create: [
            ...
            createConstructionItem(KnownElement.Metalwork, PropertyOption.Frames.SteelWindow, QualityOfFinish.VeryGood),
            ...
            createConstructionItem(KnownElement.PlumbingAndDrainage, PropertyOption.PlumbingAndDrainage.Yes, QualityOfFinish.VeryGood, 'Enter number of bathrooms', 3),
            ...
            createConstructionItem(KnownElement.MechanicalWorks, PropertyOption.MechanicalWorks.Yes, QualityOfFinish.VeryGood, 'Enter number of aircons', 3),
