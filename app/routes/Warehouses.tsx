...
export async function loader({ request }: LoaderArgs) {
  ...
  const calculatorKind = CalculatorKind.Warehouses;
      ...
      data: {
        ...
        items: {
          create: [
            ...
            createConstructionItem(KnownElement.PlumbingAndDrainage, PropertyOption.PlumbingAndDrainage.Yes, QualityOfFinish.Excellent, 'Enter number of wc & showers', 3),
            ...
            createConstructionItem(
              ...
              PropertyOption.MechanicalWorks.Yes,
              QualityOfFinish.Excellent,
              // 'Enter number of aircons',
              // 500,
            ),
