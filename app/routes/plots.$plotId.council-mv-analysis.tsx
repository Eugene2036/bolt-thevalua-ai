...
import {
  ...
  Bath, ToiletPaperOff, Swimming, Parking,
  Ruler2
...
export default function PlotMVAnalysisPage() {
  ...
  const handleAiSearch = async (e: FormEvent) => {
    ...
    try {
      ...
      const aiPrompt = `
                      ...
                      {
                        "analysis": {
                          "comparableIds": ["plotNumber1", "plotNumber2", "plotNumber3", "plotNumber4"],
