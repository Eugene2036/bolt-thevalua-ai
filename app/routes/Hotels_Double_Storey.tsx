...
export async function loader({ request }: LoaderArgs) {
  ...
  const calculatorKind = CalculatorKind.Hotel_DS;
      ...
      data: {
        ...
        items: {
          create: [
            ...
            createConstructionItem(KnownElement.PlumbingAndDrainage, PropertyOption.PlumbingAndDrainage.Yes, QualityOfFinish.Excellent, 'Enter number of bathrooms', 14),
            ...
            createConstructionItem(KnownElement.MechanicalWorks, PropertyOption.MechanicalWorks.Yes, QualityOfFinish.Excellent, 'Enter number of aircons', 14),
