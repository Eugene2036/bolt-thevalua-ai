...
export async function loader({ request }: LoaderArgs) {
  ...
  const calculatorKind = CalculatorKind.Multi_res_SS_up_to_500m2;
      ...
      data: {
        ...
        items: {
          create: [
            ...
            createConstructionItem(KnownElement.RoofingCover, PropertyOption.Roofing.ConcreteRoofTiles, QualityOfFinish.VeryGood),
            ...
            createConstructionItem(KnownElement.PlumbingAndDrainage, PropertyOption.PlumbingAndDrainage.Yes, QualityOfFinish.VeryGood, 'Enter number of bathrooms', 10),
            createConstructionItem(KnownElement.Paintwork, PropertyOption.Paintwork.Yes, QualityOfFinish.Good),
            createConstructionItem(KnownElement.Electrical, PropertyOption.Electrical.Yes, QualityOfFinish.Poor),
            createConstructionItem(KnownElement.MechanicalWorks, PropertyOption.MechanicalWorks.Yes, QualityOfFinish.Delapidated, 'Enter number of aircons', 1),
