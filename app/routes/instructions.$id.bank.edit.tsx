...
export async function loader({ request, params }: LoaderArgs) {
    console.log("Received NodeId: ", params.noteId)
    ...
    console.log("New Notification Record 1: ", notification);
    ...
    return json({ user, plots, userId, correctNoteId, allUsers, notification, valuerAttachments });
}
...
export const action = async ({ params, request }: ActionArgs) => {
    ...
    console.log('Compare NoteID: ', noteId);
    ...
    try {
        ...
        const { fileUrls, fileNames, fileTypes } = result.data;
        ...
        await prisma.$transaction(async (tx) => {
            console.log('BEGIN ATTACHMENTS TRANSACTION')
...
export default function CreateInstructionPage(props: Props) {
    const { plots, user, notification, correctNoteId, valuerAttachments } = useLoaderData<typeof loader>();
                                            ...
                                            <div className='grid grid-cols-1 gap-6 py-4 w-full'>
                                                <div className='grid grid-cols-2 gap-6 py-4 w-full'>
                                                    ...
                                                    <label className="grid grid-cols-2 items-center">
                                                        ...
                                                        <div className='flex flex-row items-left'>{String(telephone)}</div>
                                                    </label>
                                                    <label className="grid grid-cols-2 items-center">
                                                ...
                                                <div className='grid grid-cols-1 gap-6 py-4 w-full'>
                                                    <Card>
                                                        <div className="flex flex-col items-stretch col-span-6 gap-2 p-2">
                                                            {/* <span className="text-sm font-light text-stone-600">Images Of Asset</span> */}
