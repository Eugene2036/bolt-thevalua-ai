...
export async function loader({ request }: LoaderArgs) {
  ...
  const calculatorKind = CalculatorKind.Office_DS;
  ...
  const inputs: [string, number, number, number][] = [
    ...
    [PropertyOption.Frames.SteelWindow, ...getRowValues(sheet, 57)],
    [PropertyOption.Frames.AluminiumWindow, ...getRowValues(sheet, 58)],
    [PropertyOption.Frames.NoWindowsFitted, ...getRowValues(sheet, 59)],
    [PropertyOption.Plastering.Yes, ...getRowValues(sheet, 61)],
    [PropertyOption.Plastering.No, ...getRowValues(sheet, 62)],
    [PropertyOption.WallFinishes.Yes, ...getRowValues(sheet, 64)],
    [PropertyOption.WallFinishes.No, ...getRowValues(sheet, 65)],
    [PropertyOption.PlumbingAndDrainage.Yes, ...getRowValues(sheet, 68)],
    [PropertyOption.PlumbingAndDrainage.No, ...getRowValues(sheet, 69)],
    [PropertyOption.Paintwork.Yes, ...getRowValues(sheet, 71)],
    [PropertyOption.Paintwork.No, ...getRowValues(sheet, 72)],
    [PropertyOption.Electrical.Yes, ...getRowValues(sheet, 74)],
    [PropertyOption.Electrical.No, ...getRowValues(sheet, 75)],
    [PropertyOption.MechanicalWorks.Yes, ...getRowValues(sheet, 77)],
    [PropertyOption.MechanicalWorks.No, ...getRowValues(sheet, 78)],
      ...
      data: {
        ...
        items: {
          create: [
            ...
            createConstructionItem(KnownElement.Concrete, PropertyOption.Concrete.Yes, QualityOfFinish.Good),
            createConstructionItem(KnownElement.Brickwork, PropertyOption.Bricks.StockBricks, QualityOfFinish.Poor),
            createConstructionItem(KnownElement.RoofingCover, PropertyOption.Roofing.ConcreteRoofTiles, QualityOfFinish.Fair),
            createConstructionItem(KnownElement.RoofingTrusses, PropertyOption.Trusses.TimberRoofTrusses, QualityOfFinish.Poor),
            createConstructionItem(KnownElement.CarpentryAndJoineryDoors, PropertyOption.CarpentryAndJoineryDoors.Yes, QualityOfFinish.Delapidated),
            ...
            createConstructionItem(KnownElement.MechanicalWorks, PropertyOption.MechanicalWorks.Yes, QualityOfFinish.Excellent, 'Enter number of aircons', 500),
