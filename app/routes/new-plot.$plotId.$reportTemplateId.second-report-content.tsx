...
export async function loader({ request, params }: LoaderArgs) {
    ...
    return json({ Plot, reportTemplate, sayMarket, sayForced, sayReplacementValue });
}
...
export const action = async ({ params, request }: ActionArgs) => {
    ...
    try {
        ...
        await prisma.$transaction(async (tx) => {
            ...
            //         fairValue: Number(plot.marketValue),
            //         forcedSaleValue: 0,
            //         insuranceReplacementCost: 0,
            //         capRate: plot.capRate,
            //         capitalValue: 0,
            //         landValue: 0,
        ...
        return redirect(AppLinks.SecondValuationReport(plotId));
...
export default function PlotValuerDetails() {
    const { Plot, reportTemplate, sayMarket, sayForced, sayReplacementValue } = useLoaderData<typeof loader>();
    ...
    const [MarketValue] = useState(sayMarket);
    const [ForcedSaleValue] = useState(sayForced);
    const [ReplacementValue] = useState(sayReplacementValue);
                    ...
                    >
                        <Card>
                            <CardHeader className="flex flex-col justify-center items-center">
                                <h2 className="text-xl font-semibold">5. Report Content</h2>
                            </CardHeader>
