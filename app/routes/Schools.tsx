...
export async function loader({ request }: LoaderArgs) {
  ...
  const calculatorKind = CalculatorKind.Schools;
      ...
      data: {
        ...
        items: {
          create: [
            ...
            createConstructionItem(KnownElement.PlumbingAndDrainage, PropertyOption.PlumbingAndDrainage.Yes, QualityOfFinish.Excellent, 'Enter number of bathrooms', 5),
