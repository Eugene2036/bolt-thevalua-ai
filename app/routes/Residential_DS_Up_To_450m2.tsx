...
export async function loader({ request }: LoaderArgs) {
  ...
  const calculatorKind = CalculatorKind.Residential_DS_UP_TO_450M2;
      ...
      data: {
        ...
        items: {
          create: [
            ...
            createConstructionItem(KnownElement.Concrete, PropertyOption.Concrete.Yes, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.Brickwork, PropertyOption.Bricks.StockBricks, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.RoofingCover, PropertyOption.Roofing.IBR, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.RoofingTrusses, PropertyOption.Trusses.TimberRoofTrusses, QualityOfFinish.Delapidated),
            createConstructionItem(KnownElement.CarpentryAndJoineryDoors, PropertyOption.CarpentryAndJoineryDoors.Yes, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.CarpentryAndJoineryFittedKitchen, PropertyOption.CarpentryAndJoineryFittedKitchen.Yes, QualityOfFinish.VeryGood),
            ...
            createConstructionItem(KnownElement.Ceilings, PropertyOption.Ceilings.Yes, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.FloorCoverings, PropertyOption.Flooring.Tiling, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.Metalwork, PropertyOption.Frames.AluminiumWindow, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.Plastering, PropertyOption.Plastering.Yes, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.WallFinishes, PropertyOption.WallFinishes.Yes, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.PlumbingAndDrainage, PropertyOption.PlumbingAndDrainage.Yes, QualityOfFinish.VeryGood, 'Enter number of bathrooms', 4),
            createConstructionItem(KnownElement.Paintwork, PropertyOption.Paintwork.Yes, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.Electrical, PropertyOption.Electrical.Yes, QualityOfFinish.VeryGood),
            createConstructionItem(KnownElement.MechanicalWorks, PropertyOption.MechanicalWorks.Yes, QualityOfFinish.VeryGood, 'Enter number of aircons', 4),
