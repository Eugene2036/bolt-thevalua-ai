...
export async function loader({ request }: LoaderArgs) {
  ...
  const calculatorKind = CalculatorKind.Outbuilding;
      ...
      data: {
        ...
        items: {
          create: [
            ...
            createConstructionItem(KnownElement.Brickwork, PropertyOption.Bricks.Blocks, QualityOfFinish.Excellent),
            createConstructionItem(KnownElement.RoofingCover, PropertyOption.Roofing.CorrugatedRoofingSheets, QualityOfFinish.VeryGood),
            ...
            createConstructionItem(KnownElement.PlumbingAndDrainage, PropertyOption.PlumbingAndDrainage.Yes, QualityOfFinish.VeryGood, 'Enter number of bathrooms', 1),
            ...
            createConstructionItem(KnownElement.MechanicalWorks, PropertyOption.MechanicalWorks.Yes, QualityOfFinish.VeryGood, 'Enter number of aircons', 0),
