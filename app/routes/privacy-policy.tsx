      ...
      <div className="flex flex-auto flex-col justify-center pb-4">
        ...
        <div className="mx-auto w-full max-w-[80%] px-8 pt-40">
          ...
          <div className="flex flex-col items-stretch gap-4 text-justify">
            ...
            <p>
              This Privacy Policy explains how <b>TheValua Pty Limited</b> ("we," "us," or "our") collects, uses, discloses, and safeguards your information when you use our property valuation app ("App"). By using the App, you agree to the terms of this Privacy Policy.
            </p>

            <p>
              We use Your Personal data to provide and improve the App. By using the App, You agree to the
            ...
            <p>
              ...
              <ul>
                ...
                <li>
                  ...
                  TheValua (Pty) Ltd, Plot 75774, First Floor, Gaborone.
                </li>
                <li>
                ...
                <li>
                  <b>Country</b> refers to: Botswana
                </li>
                <li>
                ...
                <li>
                  <b>Personal Data</b> is any information that relates to an identified or identifiable individual. Service
                ...
                <li>
                  <b>Website</b> refers to TheValua, accessible from https://thevalua.com/
                </li>
                <li>
            ...
            <p>
              ...
              <ul>
                ...
                <li>
                  <b>For business transfers</b>: We may share or transfer Your personal information in connection with, or
                  during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion
                  of Our business to another company.
                </li>
                <li>
                  <b>With Affiliates</b>: We may share Your information with Our affiliates, in which case we will require
            ...
            <p>
              ...
              <ul>
                <li>By email: info@thevalua.com</li>
              </ul>
            </p>
          </div>
        </div>
