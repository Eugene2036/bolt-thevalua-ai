...
module.exports = {
    apps: [
        {
            name: 'thevalua-demo', // Name of your application
            ...
            cwd: '/home/thevalb9c4y6/public_html/demo', // Path to your project
            ...
            env: {
                ...
                ORIGIN: process.env.ORIGIN || 'http://localhost:3002', // Use environment variable or default
                PORT: process.env.PORT || 3002, // Use environment variable or default
